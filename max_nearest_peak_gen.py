...
for i in range(len(res)):
    fp = '/Users/josh/projects/intro/'+source+'/max/'+source+'_12m+7m+tp_co21_'+str(res[i])+'pc_props.fits.bz2'
    tab = Table.read(fp)
    ...
    cat.to_csv(loc+'/'+source+'/max/'+source+'_'+str(res[i])+'pc_cloud_stats.csv', index=False)
