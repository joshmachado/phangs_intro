...
plt.hist(cat60.true_dist_corr, bins = (np.linspace(0, 300, 10)), label=r'60pc (N = '+str(len(cat60.true_dist))+')', alpha = 0.25)
plt.hist(cat90.true_dist_corr, bins = (np.linspace(0, 300, 10)), label=r'90pc (N = '+str(len(cat90.true_dist))+')', alpha = 0.25)
plt.hist(cat120.true_dist_corr, bins = (np.linspace(0, 330, 10)), label=r'120pc (N = '+str(len(cat120.true_dist))+')', alpha = 0.25)
plt.hist(cat150.true_dist_corr, bins = (np.linspace(0, 300, 10)), label=r'150pc (N = '+str(len(cat150.true_dist))+')', alpha = 0.25)
plt.legend()
