...
#FORMATTING LEGEND
first = mlines.Line2D([], [], color='blue', lw=1, label='1st Nearest Neighbor')
second = mlines.Line2D([], [], color='red', lw=1, label='2nd Nearest Neighbor')
third = mlines.Line2D([], [], color='green', lw=1, label='3rd Nearest Neighbor')
...
plt.scatter(sep[0,0,:,0]-8, sep[0,0,:,1], c='blue', label='1st Homogenized')
plt.errorbar(sep[0,0,:,0]-8, sep[0,0,:,1], c='blue', xerr=None, yerr=err[0,0], capsize=4, ls='none')
plt.scatter(msep[0,0,:,0]-6, msep[0,0,:,1], c='blue', marker='s', label='1st Matched')
plt.errorbar(msep[0,0,:,0]-6, msep[0,0,:,1], c='blue', xerr=None, yerr=merr[0,0], capsize=4, ls='none')
plt.scatter(sep[0,1,:,0]-1, sep[0,1,:,1], c='red', label='2nd Homogenized')
plt.errorbar(sep[0,1,:,0]-1, sep[0,1,:,1], c='red', xerr=None, yerr=err[0,1], capsize=4, ls='none')
plt.scatter(msep[0,1,:,0]+1, msep[0,1,:,1], c='red', marker='s', label='2nd Matched')
plt.errorbar(msep[0,1,:,0]+1, msep[0,1,:,1], c='red', xerr=None, yerr=merr[0,1], capsize=4, ls='none')
plt.scatter(sep[0,2,:,0]+5, sep[0,2,:,1], c='green', label='3rd Homogenized')
plt.errorbar(sep[0,2,:,0]+5, sep[0,2,:,1], c='green', xerr=None, yerr=err[0,2], capsize=4, ls='none')
plt.scatter(msep[0,2,:,0]+7, msep[0,2,:,1], c='green', marker='s', label='3rd Matched')
plt.errorbar(msep[0,2,:,0]+7, msep[0,2,:,1], c='green', xerr=None, yerr=merr[0,2], capsize=4, ls='none')
...
plt.figure(figsize=(10,10))
plt.scatter(sep[1,0,:,0]-8, sep[1,0,:,1], c='blue', label='1st Homogenized')
plt.errorbar(sep[1,0,:,0]-8, sep[1,0,:,1], c='blue', xerr=None, yerr=err[1,0], capsize=4, ls='none')
plt.scatter(msep[1,0,:,0]-6, msep[1,0,:,1], c='blue', marker='s', label='1st Matched')
plt.errorbar(msep[1,0,:,0]-6, msep[1,0,:,1], c='blue', xerr=None, yerr=merr[1,0], capsize=4, ls='none')
plt.scatter(sep[1,1,:,0]-1, sep[1,1,:,1], c='red', label='2nd Homogenized')
plt.errorbar(sep[1,1,:,0]-1, sep[1,1,:,1], c='red', xerr=None, yerr=err[1,1], capsize=4, ls='none')
plt.scatter(msep[1,1,:,0]+1, msep[1,1,:,1], c='red', marker='s', label='2nd Matched')
plt.errorbar(msep[1,1,:,0]+1, msep[1,1,:,1], c='red', xerr=None, yerr=merr[1,1], capsize=4, ls='none')
plt.scatter(sep[1,2,:,0]+5, sep[1,2,:,1], c='green', label='3rd Homogenized')
plt.errorbar(sep[1,2,:,0]+5, sep[1,2,:,1], c='green', xerr=None, yerr=err[1,2], capsize=4, ls='none')
plt.scatter(msep[1,2,:,0]+7, msep[1,2,:,1], c='green', marker='s', label='3rd Matched')
plt.errorbar(msep[1,2,:,0]+7, msep[1,2,:,1], c='green', xerr=None, yerr=merr[1,2], capsize=4, ls='none')
...
plt.figure(figsize=(10,10))
plt.scatter(sep[2,0,:,0]-8, sep[2,0,:,1], c='blue', label='1st Homogenized')
plt.errorbar(sep[2,0,:,0]-8, sep[2,0,:,1], c='blue', xerr=None, yerr=err[2,0], capsize=4, ls='none')
plt.scatter(msep[2,0,:,0]-6, msep[2,0,:,1], c='blue', marker='s', label='1st Matched')
plt.errorbar(msep[2,0,:,0]-6, msep[2,0,:,1], c='blue', xerr=None, yerr=merr[2,0], capsize=4, ls='none')
plt.scatter(sep[2,1,:,0]-1, sep[2,1,:,1], c='red', label='2nd Homogenized')
plt.errorbar(sep[2,1,:,0]-1, sep[2,1,:,1], c='red', xerr=None, yerr=err[2,1], capsize=4, ls='none')
plt.scatter(msep[2,1,:,0]+1, msep[2,1,:,1], c='red', marker='s', label='2nd Matched')
plt.errorbar(msep[2,1,:,0]+1, msep[2,1,:,1], c='red', xerr=None, yerr=merr[2,1], capsize=4, ls='none')
plt.scatter(sep[2,2,:,0]+5, sep[2,2,:,1], c='green', label='3rd Homogenized')
plt.errorbar(sep[2,2,:,0]+5, sep[2,2,:,1], c='green', xerr=None, yerr=err[2,2], capsize=4, ls='none')
plt.scatter(msep[2,2,:,0]+7, msep[2,2,:,1], c='green', marker='s', label='3rd Matched')
plt.errorbar(msep[2,2,:,0]+7, msep[2,2,:,1], c='green', xerr=None, yerr=merr[2,2], capsize=4, ls='none')
