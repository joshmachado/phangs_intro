...
plt.hist(first_sep, bins=[0,250,500,750,1000,1250,1500,1750,2000], lw=3, fc=(0, 0, 0, 0.5), log=True,
label='First, Median Separation: '+str(np.around(np.median(first_sep), decimals=0))+' pc', hatch='/')
...
plt.hist(second_sep, bins=[0,250,500,750,1000,1250,1500,1750,2000], log=True, ls='dotted', lw=3, fc=(1, 0, 0, 0.5), histtype='step',
...
plt.hist(third_sep, bins=[0,250,500,750,1000,1250,1500,1750,2000], log=True, ls='dashed', lw=3, fc=(0, 0, 1, 0.5), histtype='step',
label='Third, Median Separation: '+str(np.around(np.median(third_sep), decimals=0))+' pc')
plt.title('Distance to Nearest Neighbors (pc)', fontsize=16)
plt.xlabel('pc')
plt.legend()
#plt.savefig('/Users/josh/projects/intro/plots/full_sep_third.pdf')
#plt.close()
plt.savefig('/Users/josh/projects/intro/plots/full_sep.pdf')
plt.show()
plt.close()
